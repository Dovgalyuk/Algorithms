...
void test_avltree_basic() {
    ...
    std::cout << "AVLTree basic tests passed!" << std::endl;
}

void test_avltree_1000_elements() {
    AVLTree t;
    std::string value;
...
void test_avltree_10000_elements() {
    AVLTree t;
    std::string value;
...
void test_avltree_100000_elements() {
    AVLTree t;
    std::string value;
...
int main() {
    test_avltree_basic();
    test_avltree_1000_elements();
    test_avltree_10000_elements();
    test_avltree_100000_elements();
    test_avltree_1_million();

    std::cout << "ALL AVLTREE TESTS PASSED!" << std::endl;
    return 0;
}