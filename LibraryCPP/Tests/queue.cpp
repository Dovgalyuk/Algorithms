...
int main()
{
    ...
    if (queue_get(queue).first != 1 || queue_get(queue).second != 1)
    {
    ...
    if (queue_get(queue).first != 2 || queue_get(queue).second != 2)
    {
    ...
    if (queue_get(queue).first != 3 || queue_get(queue).second != 3)
    {
