//РЕЗУЛЬТАТЫ ИЗМЕРЕНИЯ ВРЕМЕНИ РАБОТЫ ПРИ ДОБАВЛЕНИИ ЭЛЕМЕНТА ДЛЯ НОВОГО КОНТЕЙНЕРА И ДЛЯ STD::SET
//ОБЪЕМ ДАННЫХ		0,08 Мб(10 тыс. стр.)	0,8 Мб(100 тыс. стр.)	8,3 Мб(1 млн. стр.)
//КОНТЕЙНЕР			0,4 сек					5,1 сек					62,6 сек
//STD::SET			0,7 сек					7,3 сек					79,2 сек
