...
void setRussianLocale() { //функция русской локализации windows
    SetConsoleOutputCP(CP_UTF8); //UTF-8 кодировка
...
public:
    FixedArray(size_t size) : capacity(size) { //содание массива заданного размера
