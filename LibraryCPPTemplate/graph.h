...
public:
    ...
    struct VertexIterator
    {
        ...
        VertexIterator(Graph* graph) : graph(graph) {}
    ...
    struct NearVertexIterator
    {
        ...
        NearVertexIterator(Graph* graph, size_t root_vertex) : graph(graph), root_vertex(root_vertex) { last_index = find_next_vertex(); }
    ...
    Graph(size_t vertex_amount, Data default_value) : matrix(new Vector<Edge>)
    {
