...
int main() {
	...
	if (graph->check_edge_with_empty(graph->get_vertex(0), graph->get_vertex(1)), graph->get_vertex(0)->get_edge(graph->get_vertex(1))->get_weight() != 10) {
	...
	graph->get_vertex(0)->get_edge(graph->get_vertex(1))->set_weight(95);

	if (graph->get_vertex(0)->get_edge(graph->get_vertex(1))->get_weight() != 95) {
