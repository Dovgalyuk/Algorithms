...
int main(int argc, char* argv[]) {
    try { // Начинаем блок обработки исключений
        if (argc != 3) { // Если количество аргументов не равно 3 (включая имя программы)
            cerr << "Usage: " << argv[0] << " <file1> <file2>\n"; // Выводим сообщение о том, как использовать программу
            return 1; // Завершаем программу с кодом ошибки
        }

        int size; // Переменная для хранения размера массива
        string filename1 = argv[1]; // Имя файла для первой задачи
        string filename2 = argv[2]; // Имя файла для второй задачи
